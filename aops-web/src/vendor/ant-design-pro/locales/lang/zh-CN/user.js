export default {
  ...
  'user.giteelogin.username.placeholder': 'gitee账号',
  ...
  'user.login.gitee-login-credentials': 'gitee账号登陆',
  ...
  'user.login.login': '登录',
  'user.login.gitee-login': '使用gitee账号登陆',
  ...
  'user.giteeName.required': '请输入gitee账号',
