...
import importlib
import operator
from swagger_server.analy.openEuler_repo import OpenEulerRepo
...
class YangModule(object):
    ...
    def create_ini_object(self, module):
        ...
        all_path = "swagger_server.analy." + project_name
    ...
    def add_ini_content_in_object(self, module_obj, content):
        ...
        print("sections_module is : {}".format(sections_module))
        print("sections_repo is : {}".format(sections_repo))
        ...
        for repo_section in sections_repo:
            ...
            for d_opt in repo_options:
                ...
                m_section = self.get_mactch_section(d_opt, module_obj)
                print("m_section is : {}".format(m_section))
    ...
    def get_mactch_section(self, option, module):
        """
        desc: return the match section in module accroding the section
        """
        res = None
        for m_section in module.sections():
            module_options = module.options(m_section)
