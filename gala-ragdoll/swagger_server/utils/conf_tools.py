...
from swagger_server.models.real_conf_path import RealConfPath
    ...
    example:
        input:
            manage_confs : [{
                    ...
                    'expectedValue': 'http://repo.openeuler.org/openEuler-20.03-LTS-SP1/OS/$basearch/RPM-GPG-KEY-openEuler\n'
                    'path': 'OS/yum/openEuler.repo/OS/gpgkey'
                }
            ]
        output:
            manage_confs_dict: {
                    "OS" : {
                        "yum" : {
                            "openEuler.repo" : {
                                "OS" : {
                                    "enabled": "1"
                                    "gpgcheck": "http://repo.openeuler.org/openEuler-20.03-LTS-SP1/OS/$basearch/RPM-GPG-KEY-openEuler\n"
                                }
                            }
                        }
                    }
