...
# ******************************************************************************/
"""
@FileName: test_resolv_config.py
...
from ragdoll.config_model.resolv_config import ResolvConfig
...
CONF_INFO = "search localdomain \n" \
            "nameserver 192.168.1.1 \n" \
            "search  example.com.  51osos.com \n" \
            "nameserver 192.168.2.1 \n"
ERROR_CONF_INFO = "s localdomain \n" \
                  "nameserver 192.168.1.1 \n" \
                  "search  example.com.  51osos.com \n" \
                  "nameserver 192.168.1.1 \n"
...
class TestResolvConfig(BaseTestCase):
    ...
    def test_write_conf(self):
        ...
        resolv_config.conf = conf_dict_list
