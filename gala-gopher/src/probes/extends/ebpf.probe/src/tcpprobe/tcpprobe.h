...
#define KERNEL_RELEASE_OF_OPENEULER_2209    106
#if (CURRENT_KERNEL_VERSION == KERNEL_VERSION(5, 10, 0) && KER_RELEASE == KERNEL_RELEASE_OF_OPENEULER_2209)
...
#define __LOAD_PROBE(probe_name, end, load) \
    ...
    MAP_SET_PIN_PATH(probe_name, tcp_output, TCP_LINK_OUTPUT_PATH, load); \
